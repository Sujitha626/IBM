...
public class BookController {
	...
	@GetMapping("/api/books/find1/{bookName}")
	public ResponseEntity<List<Book>> getByBookName(@PathVariable("bookName") String bookName)
	{
		log.info("within get by bookName");
		return ResponseEntity.status(HttpStatus.OK).body(bookService.getByBookName(bookName));
	}
